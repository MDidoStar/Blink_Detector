...
def load_data():
    try:
        ...
        # Now only expecting Country and City columns
...
# Use number_input with plus/minus buttons instead of dropdown
age_num = st.number_input(
    "Age", 
    min_value=1, 
    max_value=123, 
    value=25,  # Default starting value
    step=1,
    key="age_input",
    help="Use the +/- buttons or type your age (1-123)"
)
